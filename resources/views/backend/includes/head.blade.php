...
<!-- Theme style -->
<link rel="stylesheet" href="{{URL::asset('public/css/dist/AdminLTE.min.css')}}">
<!-- AdminLTE Skins. Choose a skin from the css/skins
     folder instead of downloading all of them to reduce the load. -->
<link rel="stylesheet" href="{{URL::asset('public/css/dist/skins/_all-skins.min.css')}}">
<!-- iCheck -->
...
<!-- AdminLTE App -->
<script src="{{URL::asset('public/js/dist/app.min.js')}}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{URL::asset('public/js/dist/pages/dashboard.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{URL::asset('public/js/dist/demo.js')}}"></script>
